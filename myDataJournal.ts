class DataEntry {
    ...
    constructor(day : string, sleepHours: number, screenTime: number, mood: Mood, caffeineIntake: number, focusLevel: number) {
...
function mostFrequentMood() : string {
    let entries : number[] = [0, 0, 0, 0]; // Good, Great, Okay, Bad
...
// Not my best work.
function correlateCaffeineToFocus() : boolean {
